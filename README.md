...
<table border="0">
 ...
 <tr>
    <td>The <b>Quantum CM4 is a SWaP-C platform : Cost-effective, Industrial, marinized IP67, -20 to +60/65°C temperature range, miniaturized, very lightweight (only 212g), very low power consumtion, fanless...</b>. It integrates a powerful quad core ARM processor, many Industrial, Marine, and Automotive field buses, Galvanic isolation, Protections, Watchdog, RTC with GNSS Time synchronisation, Wireless and a huge storage for your datalogs.<ul>
      ...
      <li><b>Hardware expansion flexibility :</b> <a href="mailto:contact@austral-eng.com">Contact us</a><ul>
        <li><b>Wireless IoT</b> : LoRaWAN, SigFox, Zigbee, Xbee, Zwave, 4G/LTE, NB-IoT...</li>
        <li><b>Satellite IoT</b> : Iridium SBD, <a href="https://swarm.space/">SpaceX Swarm</a>, <a href="https://www.kineis.com/en/">Kineis</a>, Astrocast...</li>
...
4.5. [Create your own Debian image from scratch](#debian_from_scatch)  
4.6. [Configuration current issues](#config_issues)  
