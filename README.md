...
The Quantum CM4 Processor is preinstalled with a [Debian Linux](https://www.raspberrypi.com/documentation/computers/os.html#introduction) optimized for the Raspberry Pi and Quantum hardware. The OS comes with over 35,000 packages: precompiled software bundled in a nice format for easy installation on your Quantum Processor. You can reinstall Debian from scratch by following this procedure.  
