...
- **Makes it as easy as possible to build your next smart project operating in hostile environment** with a **Raspberry PI 4** software compatible platform suitable for real-time and browser-based remote displays.  
- **Drastically reduce your development time :** Focus on your core business by using a proven hardware and OS, the support of the largest developer community.  
