...
***Any languages** : Pre-installed C/C++/Qt, Python. Easy installation of NodeJS, Node-Red, Rust, Java, C#, Go...*

***Any frameworks** : Easy installation of ROS2, TensorFlow, PyTorch, CoDeSys...*
