...
- **Connect an instrument to the cloud, make a web dashboard, troubleshoot !!! in minutes !!! :** If it is suitable for your application, you can freely use our fast system integration solution based on [Node-RED](https://github.com/austral-electronics/wiki/wiki/Node-Red) visual flow creator, which offers you a library of nearly 4000 [nodes](https://github.com/austral-electronics/wiki/wiki/Quantum-nodes-collection).  
