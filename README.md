...
In order to take advantage of the huge developer community on Raspberry PI and a good [documentation](https://www.raspberrypi.com/documentation/computers/os.html#introduction). The Quantum CM4 Processor is preinstalled with a [Debian Linux](https://www.debian.org/index.en.html) optimized for the Raspberry PI 4 and configured for the Quantum CM4 hardware. The OS comes with over 35,000 packages: precompiled software bundled in a nice format for easy installation. You can reinstall Debian from scratch by following this procedure.  
